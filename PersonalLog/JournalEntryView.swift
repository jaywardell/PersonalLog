    ...
    var body: some View {
        NavigationView {
            ...
            .sheet(isPresented: $showPromptsList) {
                PhrasesPicker(prompt: "You can write about any of these topics", phrases: Self.Prompts, initialPhrase: viewModel.prompt, doneButtonTitle: "Write about This") { prompt in
