...
class TopViewController: UITabBarController {
    ...
    private lazy var journalEntryVC = UIHostingController(rootView: JournalEntryView(viewModel: .init(mood: "😀", title: "", prompt: "How was the weather today?", text: "sunny", cancel: {}, save: {})))
